...
export class firebaseMapper implements IProviderMapper {
    eventMapper: IEventMapper = {
        ...
        viewCategory: function (data: any, sdkInstance: any): void {
            logEvent(sdkInstance.analytics, 'view_categories', { user_id: data?.subject_id || '' })
        },
        viewSubCategory: function (data: any, sdkInstance: any): void {
            logEvent(sdkInstance.analytics, 'view_category', { user_id: data?.subject_id || '', category_id: data?.category_id })
        },
        ...
        startCheckout: function (data: any, sdkInstance: any): void {
            logEvent(sdkInstance.analytics, 'begin_checkout', { user_id: data?.subject_id || '' })
        },
        completeCheckout: function (data: any, sdkInstance: any): void {
            logEvent(sdkInstance.analytics, "complete_checkout", { user_id: data?.subject_id || '' })
        },
        ...
        selectHomeOnSaleProduct: function (data: { user_id: number; product_id: number; subject_id?: string }, sdkInstance: any): void {
            logEvent(sdkInstance.analytics, 'select_onsale', { user_id: data?.subject_id || '', product_id: data.product_id })
        },
